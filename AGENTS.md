...
- Cloudflare static build: `yarn build:cloudflare`
- Preview the Cloudflare Pages output: `yarn preview:cloudflare`
- Deploy the Cloudflare Pages output: `yarn deploy:cloudflare`
