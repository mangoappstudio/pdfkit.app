      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          <div style={{ fontSize: 28, lineHeight: 1.3, color: "#334155", maxWidth: 920 }}>
            Redact, extract, reorder, watermark, and merge PDFs locally in your browser. No uploads. No accounts.
          </div>
        </div>

        <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
          {["100% browser-based", "No uploads", "No account required"].map((label) => (
            <div
              key={label}
              style={{
                display: "flex",
